...
function Process() {
  return (
    <div className="w-full flex flex-col justify-between mt-3">
      ...
      <div className="w-full rounded-3xl m-1 md:h-240 border-1 border-black">
        <div className="w-full rounded-3xl m-1 p-6 ">
          <div className="h-2/15 border-b border-black flex flex-col md:flex-row justify-between items-center p-5 ">
          ...
          <div className="h-2/15 flex flex-col md:flex-row justify-between items-center p-5 ">
            <h1 className="lobster  md:text-3xl text-2xl h-1/4">
        ...
        <div className="h-1/15 flex flex-col md:flex-row justify-between items-center p-5 ">
          <div className="h-1/7 w-full flex justify-between items-end text-[#ff003D] p-3 lobster ">
            <p className="text-[#ff003D]">(Process)</p>
            <p className="text-black">
              <span className="mb-[2px] mr-[3px]">●</span>101/010
            </p>
          </div>
        </div>
      </div>

  ...
  return (
    <div className="w-full flex flex-col justify-between mt-3">
      ...
      <div className="w-full flex flex-col justify-between p-5 rounded-3xl bg-[#5900cc] m-1 md:h-160 ">
        <p className="h-1/7 font-bold text-6xl lobster">010</p>
      ...
      <div className="w-full rounded-3xl bg m-1 md:h-160 border-1 overflow-hidden border-black">
        <div className="w-full h-full pr-10 pl-10">
          ...
          <div className="h-2/7 w-full border-b-1 flex justify-evenly items-center text-[12vw] lobster border-black ">
            ...
            <p className="md:w-3/5 w-3/7 md:pr-40 flex justify-end text-[#5900cc]">
              AM
            </p>
          </div>
          <div className="h-2/7 text-[#5900cc] w-full border-b-1 flex justify-start text-[12vw] lobster border-black ">
            Developer
          </div>
          <div className="h-1/7 w-full flex justify-between items-center text-[#5900cc] p-3 lobster ">
            <p>(Flex)</p>
            <p className="text-black">
      ...
      <div className="w-full lobster rounded-3xl bg-[#5900cc] m-1 md:h-350 overflow-hidden ">
        <div className="w-full h-full pl-6 pr-6 text-white">
          ...
          <div className="h-2/27 w-full flex md:mt-0 mt-5 justify-between text-[#5900cc] p-3 lobster ">
            <p className="text-white">(Flex)</p>
            <p className="text-black">
      ...
      <div className="w-full rounded-3xl bg m-1 md:h-220 p-6 border-1 border-black">
        ...
        <div className="text-[6vw] flex justify-end items-center lobster h-3/25">
          <span className="text-[#5900cc]">creative foundations</span>
        </div>
        ...
        <div className="text-[6vw] flex justify-end items-center lobster h-3/25">
          <span className="text-[#5900cc]">repetitive design&nbsp;</span>{" "}
          thinking
        </div>
        <div className="text-[6vw] mb-5 md:mb-0  lobster flex justify-end h-1/25 ">
          <div className="text-[6vw] w-4/5 lobster border-b-1 border-black"></div>
        ...
        <div className=" lobster flex justify-between items-center h-3/25">
          ...
          <p className="text-[6vw]">
            and shaping&nbsp;<span className="text-[#5900cc]">AI-powered,</span>
          </p>
        </div>
        <div className="text-[6vw] mb-5 md:mb-0 flex justify-end items-center lobster h-3/25">
          future-ready&nbsp;
          <span className=" text-[#5900cc]">digital experiences.</span>
        </div>
        <div className="h-2/25 w-full flex justify-between items-end text-[#5900cc] p-3 lobster ">
          <p>(Flex)</p>
          <p className="text-black">

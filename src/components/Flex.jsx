  ...
  return (
    <div className="w-full flex flex-col justify-between mt-3">
          ...
          <div className="h-4/7 w-full md:border-b-1 flex flex-col md:flex-row justify-evenly md:pt-5 gap-2 md:gap-0 md:pb-5 lobster border-black ">
            <div className="md:w-3/13 h-full md:block flex items-center justify-between mr-4 md:border-r-1 border-b-1 md:border-b-0 border-black ">
              ...
              <div className="h-1/4 flex justify-center items-center w-full text-2xl">
                <p className="text-[#5900cc]">Happy clients</p>{" "}
              </div>
            </div>
            <div className="md:w-3/13 h-full md:block flex items-center justify-between mr-4 md:border-r-1 border-b-1 md:border-b-0 border-black ">
              <div className="h-3/4 text-xl md:text-8xl w-full flex justify-center items-center ">
              ...
              <div className="h-1/4 flex justify-center items-center w-full text-2xl">
                <p className="text-[#5900cc]">Year's experiences</p>{" "}
              </div>
            </div>
            <div className="md:w-3/13 h-full md:block flex items-center justify-between mr-4 md:border-r-1 border-b-1 md:border-b-0 border-black ">
              <div className="h-3/4 text-xl md:text-8xl w-full flex justify-center items-center ">
              ...
              <div className="h-1/4 flex justify-center items-center w-full text-2xl">
                <p className="text-[#5900cc]">Projects delivered</p>{" "}
              </div>
            </div>
            <div className="md:w-3/13 h-full md:block flex items-center justify-between mr-4 ">
              ...
              <div className="h-1/4 flex justify-center items-center w-full text-2xl">
                <p className="text-[#5900cc]">Peoples use my product</p>{" "}
              </div>
            </div>
          </div>
          <div className="h-1/7 text-[#5900cc] w-full border-b-1 md:border-b-0 flex justify-start text-[12vw] lobster border-black "></div>
      ...
      <div className="w-full rounded-3xl bg m-1 md:h-100 p-5 md:p-10 border-1 overflow-hidden border-black">
        <p className="h-6/8 text-9xl md:text-[20vw] rotate-90 text-[#5900cc] flex justify-center items-center ">
          :)
        </p>
        <div className="h-1/8 text-[#5900cc] w-full border-b-1 md:border-b-0 flex justify-start text-[12vw] lobster border-black "></div>
        <div className="h-1/8 w-full flex justify-between items-center text-[#5900cc] p-3 lobster ">
          <p>(Flex)</p>
          <p className="text-black">
            <span className="mb-[2px] mr-[3px]">●</span>001/010
          </p>
